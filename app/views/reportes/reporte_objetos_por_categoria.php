...
<body>
    ...
    <h2>Reporte de Objetos Perdidos por Categoría</h2>
    <hr>

    <!-- FORMULARIO PARA GENERAR PDF -->
    <form action="index.php?action=reporteObjetosPorCategoria" method="POST">

        <label><b>Seleccione la categoría:</b></label><br>
    ...
    ============================== -->
    <h3>Objetos registrados por categoría</h3>
    ...
    <a href="index.php?action=pdf_pieCategoria">
